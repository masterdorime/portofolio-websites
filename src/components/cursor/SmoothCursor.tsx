// Adapted from Magic UI SmoothCursor (MIT License): physics-based arrowhead
// cursor with velocity rotation. Ported to framer-motion (same spring API)
// and recolored to follow the site theme instead of fixed black/white.
'use client';
