...
export interface DepthCarouselProps {
  ...
  onChange?: (index: number, item: DepthItem) => void;
  className?: string;
}
...
const normalizeItem = (it: DepthItem | string): DepthItem => (typeof it === 'string' ? { image: it, alt: '' } : it);
...
const DepthCarousel = ({
  ...
  const dragRef = useRef<{
    x: number; startPos: number; lastX: number; lastT: number; v: number; moved: boolean; id: number;
  } | null>(null);
