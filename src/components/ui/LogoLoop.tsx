...
'use client';
import { useCallback, useEffect, useMemo, useRef, useState, memo, type CSSProperties, type ReactNode, type RefObject } from 'react';
import './LogoLoop.css';
        ...
        if (renderItem) {
          return (
            <li className="logoloop__item" key={key} role="listitem">
              {renderItem(item, typeof key === 'number' ? key : 0)}
            </li>
          );
        }
