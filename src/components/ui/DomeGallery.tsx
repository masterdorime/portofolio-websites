...
// Change for this site: the click-to-enlarge viewer shows the FULL photo at
// natural aspect (contain) instead of a cropped cover, so every shot pops up
// as close to original as fits the viewport.
'use client';
...
const DEFAULT_IMAGES: DomeImage[] = [
  { src: 'https://picsum.photos/seed/dome1/800/1000', alt: 'Abstract art' },
  { src: 'https://picsum.photos/seed/dome2/800/1000', alt: 'Modern sculpture' },
  { src: 'https://picsum.photos/seed/dome3/800/1000', alt: 'Digital artwork' },
];
...
interface Tile extends TileCoord {
  src: string;
  alt: string;
}

function buildItems(pool: Array<DomeImage | string>, seg: number): Tile[] {
...
export default function DomeGallery({
  ...
  return (
    ...
    >
      <main ref={mainRef as React.Ref<HTMLElement>} className="sphere-main">
        <div className="stage">
